...
st.title("🍽️ AI-Powered Recipe Recommender")
...
if search_button:
    ...
    if not ingredients_text.strip():
        ...
        with st.spinner("🤖 AI is generating 3 perfect recipes..."):
            try:
                ...
                if recipes is None or len(recipes) == 0:
                    ...
                    # Display results
                    st.success(f"✅ {len(recipes)} Recipes Generated by AI!")
                    ...
                    for idx, (tab, recipe) in enumerate(zip(tabs, recipes)):
                        with tab:
                            ...
                            with col1:
                                st.header(f"🍲 {recipe['recipe_name']}")
                                ...
                                with detail_col2:
                                    st.metric("🍜 Meal Type", recipe['meal_type'])
                            ...
                            with col2:
                                ...
                                st.write(f"**Generated by:** Gemini AI ✨")
